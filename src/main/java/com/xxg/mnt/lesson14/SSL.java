...
public class SSL {
    public static SSLContext getSSLContext_client() throws Exception{
        ...
        ks.load(new FileInputStream("F:\\code+ziliao\\《MINA、Netty、Twisted一起学》系列教程源码\\mina-netty-twisted\\src\\main\\resources\\lesson13\\client\\kclient.keystore"), "123456".toCharArray());
        tks.load(new FileInputStream("F:\\code+ziliao\\《MINA、Netty、Twisted一起学》系列教程源码\\mina-netty-twisted\\src\\main\\resources\\lesson13\\client\\tclient.keystore"), "123456".toCharArray());
